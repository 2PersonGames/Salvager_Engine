...
namespace SalvagerEngine.Storage.Content
{
    public class SalvagerContentManager : Microsoft.Xna.Framework.Content.ContentManager
    {
        ...
        public SalvagerContentManager(Game game, string root_directory)
        ...
        public void LoadTextureMap(string texture_filename, string data_filename)
        {
            ...
            {
                texture = Texture2D.FromStream(mGraphicsDevice, new StreamReader(Path.Combine(RootDirectory, texture_filename)).BaseStream);
            }
